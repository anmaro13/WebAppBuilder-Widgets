define(['dojo/_base/declare', "dijit/registry", "dojo/dom", "dojo/on", "esri/domUtils", 'dijit/_WidgetsInTemplateMixin', 'jimu/BaseWidgetSetting', 'dijit/TitlePane', 'dijit/form/NumberTextBox', 'dijit/form/TextBox', 'dijit/form/CheckBox'], function (declare, registry, dom, on, domUtils, _WidgetsInTemplateMixin, BaseWidgetSetting) {
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    onClick_property: function onClick_property() {
    ...
    onClick_Description: function onClick_Description() {
    ...
    onClick_Year: function onClick_Year() {
    ...
    onClick_Building: function onClick_Building() {
    ...
    onClick_Construction: function onClick_Construction() {
    ...
    onClick_Area: function onClick_Area() {
    ...
    onClick_Hazard: function onClick_Hazard() {
    ...
    onClick_Floors: function onClick_Floors() {
    ...
    onClick_Market: function onClick_Market() {
    ...
    onClick_Items: function onClick_Items() {
    ...
    onClick_Inhabitability: function onClick_Inhabitability() {
    ...
    onClick_Customer: function onClick_Customer() {
