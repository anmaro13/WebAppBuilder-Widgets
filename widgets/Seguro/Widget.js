define(['dojo/_base/declare',
  ...
  domUtils, Geoprocessor, Legend, SpatialReference, Point) {
    ...
    return declare([BaseWidget], {
      ...
      this.cleanup();
      if(anio==="" | edificio==="" |peligrosidad==="" |material==="" |deductible===""| mercado >1000000 | construccion==="" | superficie==="" | mercado==="" | objetos===""
        | bienes==="" | temporal==="" | cliente===""  ){
      ...
      startup: function() {
        var gpServiceUrl= "https://localhost:6443/arcgis/rest/services/App_insurance/GPSeguro/GPServer/ScriptEdificios";
